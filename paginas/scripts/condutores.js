...
function capacidade(mat, sec, met, iso, res, imagem){
  ...
  /* ======================================RESULTADO======================================= */  
    if (material == 'aluminio' && seccao < 16){
        ...
        resultado.innerHTML = `<p>Um Condutor de <strong>${material}</strong> com a seção de <strong>${seccao}mm<sup>2</sup></strong> com o isolamento de <strong>${isolamento}</strong> no metodo de referência <strong>${metodo}</strong> tem a capacidade de <strong>${capacidade2}</strong> com 2 condutores carregados e  <strong>${capacidade3}</strong> com 3 condutores carregados</p>`
